...
function CriaDataTableSaidaProdutos() {

    $("#dtSaidaProdutos").DataTable({                   
        "responsive":true,
        "lengthChange": true,
        "autoWidth": true,         
    ...
    }).buttons().container().appendTo('#dtSaidaProdutos_wrapper .col-md-6:eq(0)');
}
...
function ExcluirVarios(registro) {
    var url = "/SaidaProdutos/ExcluirVarios/";
